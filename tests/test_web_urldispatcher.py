...
if not hasattr(__import__('aiohttp').web_urldispatcher.StaticResource, '_version_hash'):
    pytest.skip("append_version not supported in aiohttp 2.3.10", allow_module_level=True)
